...
require (
	github.com/kmuto/opentelemetry-collector-components-kmuto/receiver/samsareceiver v0.0.1
...
replace github.com/kmuto/opentelemetry-collector-components-kmuto/receiver/samsareceiver => ./receiver/samsareceiver
